...
export function PokemonCard({ pokemon }: PokemonCardProps) {
  ...
  return (
    <Link href={`/pokemon/${pokemon.id}`} className="block h-full">
      <Card className="h-full overflow-hidden bg-white border-0 shadow-md rounded-xl hover:shadow-xl transition-shadow duration-300 relative group flex flex-col justify-between py-2 gap-2">
